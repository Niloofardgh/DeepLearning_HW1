...
class KNearestNeighbor(object):
    ...
    def compute_distances_no_loops(self, X):
        ...
        # Use broadcasting to compute squared differences efficiently.  
        squared_diffs = np.sum((self.X_train**2).T + (X**2) - 2*X.dot(self.X_train.T), axis=0).reshape(num_test, num_train)  
